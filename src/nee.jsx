    ...
    <div>
      ...
      <div className="bg-black w-[1920px] h-[3328px] relative">
        {/* <LineMdMenuToCloseAltTransition
          className="!absolute !w-[47px] !h-[47px] !top-[50px] !left-[1833px]"
          color="white"
        /> */}
        <img
          className="absolute w-[1292px] h-[92px] top-[152px] left-[316px]"
          alt="Epic games an"
          src="epic-games-an-american-video-game-and-software-developer-and-publisher-based-in-cary-north-carolina.jpg"
        />
        <img src={img} alt="" />
        ...
        <div className="absolute w-[416px] h-[60px] top-[979px] left-[752px]">
          <div className="w-[418px] h-[60px]">
            <div className="relative w-[416px] h-[60px] bg-white">
              <div className="absolute w-[213px] h-[29px] top-[16px] left-[103px] [font-family:'Poppins-Regular',Helvetica] font-normal text-black text-[19px] text-center tracking-[0.96px] leading-[normal]">
                Visit Website
              </div>
            </div>
          </div>
        </div>
        <img className="absolute w-[347px] h-[347px] top-[1232px] left-[389px]" alt="Mask group" src="mask-group.png" />
        <img className="left-[787px] absolute w-[347px] h-[347px] top-[1232px]" alt="Mask group" src="image.png" />
        <img
        ...
        <div className="absolute w-[1146px] h-[153px] top-[1878px] left-[389px]">
          ...
          <p className="absolute w-[1142px] h-[81px] top-[72px] left-0 opacity-80 [font-family:'Poppins-Regular',Helvetica] font-normal text-white text-[18px] text-center tracking-[0] leading-[normal]">
            ...
            our user community. Collaborating with us represents an investment, rather than a mere expenditure. Our
            dedication to providing distinctive digital interactions guarantees unparalleled benefits for our clientele.
          </p>
        </div>
        ...
        <div className="absolute w-[938px] h-[342px] top-[2593px] left-[491px]">
          <div className="absolute w-[942px] h-[197px] top-0 left-0">
            ...
            <p className="absolute w-[864px] h-[99px] top-[98px] left-[37px] [font-family:'Roboto-Light',Helvetica] font-normal text-white text-[28px] text-center tracking-[0] leading-[normal]">
              ...
              <span className="[font-family:'Roboto-Medium',Helvetica] font-medium">hello@abc.com</span>
              <span className="[font-family:'Roboto-Regular',Helvetica]">&nbsp;</span>
              <span className="font-light">or give us a call at </span>
              <span className="[font-family:'Roboto-Medium',Helvetica] font-medium">+91 480 20802730.</span>
            </p>
          </div>
          <div className="absolute w-[375px] h-[60px] top-[282px] left-[487px]">
            <div className="relative w-[373px] h-[60px] bg-white">
          ...
          <div className="absolute w-[373px] h-[60px] top-[282px] left-[78px] border border-solid border-white">
            <div className="absolute w-[251px] h-[27px] top-[14px] left-[59px] [font-family:'Poppins-Medium',Helvetica] font-medium text-white text-[18px] text-center tracking-[0.96px] leading-[normal]">
              Ring us on Skype
            </div>
          </div>
        </div>
